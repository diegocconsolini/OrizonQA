...
// Dynamic provider setup - must use dynamic imports to avoid webpack bundling issues
export async function getAuthOptionsWithProvider() {
  // Dynamic imports to avoid build-time webpack errors with ESM/CJS interop
