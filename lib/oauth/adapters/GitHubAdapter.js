...
export default class GitHubAdapter extends OAuthProvider {
  constructor(config = {}) {
    ...
    // Use separate OAuth App for repository access if configured
    // Falls back to main GitHub OAuth credentials
    ...
    if (!this.clientId || !this.clientSecret) {
      throw new Error('GitHub OAuth credentials not configured. Set GITHUB_REPO_CLIENT_ID/SECRET or GITHUB_CLIENT_ID/SECRET');
    }
  }
