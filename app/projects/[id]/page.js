      ...
      <AppLayout>
        <div className="min-h-screen bg-bg-dark flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-text-secondary-dark mb-6">{error || 'The project you\'re looking for doesn\'t exist or you don\'t have access.'}</p>
            <Link
              href="/projects"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-xs font-mono text-text-secondary-dark bg-surface-hover-dark px-2 py-1 rounded">
                      {project.key}
                    </span>
                  </div>
                  {project.description && (
                    <p className="text-sm text-text-secondary-dark">{project.description}</p>
                  )}
                </div>
              </div>
              <button className="flex items-center gap-2 bg-surface-dark text-white border border-white/10 px-4 py-2 rounded-lg hover:bg-surface-hover-dark transition-colors">
        ...
        <div className="px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-surface-dark border border-white/10 rounded-lg p-6">
              ...
              <p className="text-sm text-text-secondary-dark">Test Cases</p>
            ...
            <div className="bg-surface-dark border border-white/10 rounded-lg p-6">
              ...
              <p className="text-sm text-text-secondary-dark">Requirements</p>
            </div>
            ...
            <div className="bg-surface-dark border border-white/10 rounded-lg p-6">
              ...
              <p className="text-sm text-text-secondary-dark">Test Runs</p>
              <p className="text-xs text-green-400 mt-2">
            ...
            <div className="bg-surface-dark border border-white/10 rounded-lg p-6">
              ...
              <p className="text-sm text-text-secondary-dark">Defects</p>
          ...
          <div className="bg-surface-dark border border-white/10 rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link
                ...
                className="flex items-center gap-3 p-4 bg-surface-hover-dark rounded-lg hover:bg-white/10 transition-colors"
              >
          ...
          <div className="bg-surface-dark border border-white/10 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between">
                <span className="text-text-secondary-dark">Owner:</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-text-secondary-dark">Last Updated:</span>
                <span className="text-white">{formatDate(project.updated_at)}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-text-secondary-dark">Status:</span>
