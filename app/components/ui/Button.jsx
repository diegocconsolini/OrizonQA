...
export default function Button({
  ...
  // Variant styles
  const variants = {
    primary: 'bg-gradient-primary text-white shadow-glow-primary hover:shadow-glow-primary-lg active:scale-95 focus:ring-primary',
    secondary: 'bg-gradient-accent text-white shadow-glow-accent hover:shadow-glow-accent-lg active:scale-95 focus:ring-accent',
