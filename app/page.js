/**
 * Landing Page - GitHub-Inspired Design
 */
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-dark relative">
      ...
      {/* NAVBAR */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-bg-dark/80 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <Logo variant="full" color="blue" size="md" background="dark" />

            <div className="flex items-center gap-6">
              <Link href="/login" className="text-text-secondary-dark hover:text-white transition-colors text-sm font-medium">
                Sign In
              </Link>
              <Link href="/signup">
      ...
      <section className="relative pt-32 pb-20 px-6 z-10">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-3xl">
            <h1 className={`text-7xl font-bold text-white mb-8 leading-tight transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              QA management built for modern teams
            </h1>

            <p className={`text-2xl text-text-secondary-dark mb-10 leading-relaxed transition-all duration-700 delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Track requirements, design test cases, execute test runs, and analyze coverage—all in one platform.
            </p>

            <div className={`flex items-center gap-4 transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <Link href="/signup">
